...
//’E’ — индикатор представления список ребер, LOE//’L’ — индикатор представления список смежных вершин AdjList
//’C’ — индикатор представления матрица смежности AdjMatx
